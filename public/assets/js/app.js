...
function initChat() {
  ...
  if (forceOpen || stored === '1') {
    // Explicit request (e.g. ?openChat=1) or user had it open already this session — respect it on any page.
    openChat();
  } else {
    // No auto-open on first visit anymore — user opens it manually via the FAB.
