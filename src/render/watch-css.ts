...
.watch-quick-nav{
  ...
  width:100%!important;
  box-sizing:border-box!important;
  padding:.5rem .15rem .2rem!important;
  margin:0!important;
  background:transparent!important;
}
.watch-auto-next,
...
.watch-auto-next:hover,
.watch-native-player:not(:disabled):hover{
...
.watch-auto-next.is-on,
.watch-native-player.is-on{
  background:rgba(232,69,60,.09)!important;
  border-color:rgba(232,69,60,.38)!important;
  color:var(--text-primary)!important;
}
.watch-auto-next.is-on .watch-toggle,
.watch-native-player.is-on .watch-native-toggle{
  background:var(--accent)!important;
}
.watch-auto-next.is-on .watch-toggle-knob,
.watch-native-player.is-on .watch-native-knob{
  transform:translateX(11px)!important;
}
.watch-native-player:disabled{
  opacity:.3!important;
